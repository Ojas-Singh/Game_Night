          ...
          <section className="home-discovery" id="games" aria-labelledby="games-title">
            ...
            <div className="discovery-grid">
              {[{ id: 'cabo', title: 'Cabo', info: 'Memory, timing & misdirection', meta: '2–6 players', symbol: '♦', tone: 'red' },
                ...
                <article className={`discovery-card game-discovery-card ${g.tone}`} key={g.id}><div className="game-card-art" aria-hidden>{g.symbol}</div><div className="game-card-meta">{g.meta}</div><h3>{g.title}</h3><p>{g.info}</p>
